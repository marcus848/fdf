...
# FILES
FILES = main.c init_structs.c error.c map.c free_structs.c init_utils.c render.c transform.c draw.c \
	utils.c projections.c frees.c color.c hooks.c rotate.c theme.c menu.c hooks2.c
...
FILES_TESTS = started_mlx.c pixel_put.c my_pixel_put.c triangulo.c events_init.c key_hook.c mouse_hook.c move_hook.c \
	      paint.c loop_hook.c sync.c bresenham.c resize.c testeIMG.c 
